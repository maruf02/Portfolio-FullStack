...
const BlogCard = ({ card }) => {
  const { _id, bolg_title, category, img, description, live_link } = card;

  return (
    <div>
      <section className=" p-2 justify-center ">
        <div className=" relative w-[410px] h-[520px] bg-[#1b1b42] flex  justify-center content-center overflow-hidden">
          <div className="login-form absolute bg-[#1b1b42] inset-1 p-2 z-10 ">
            <div className="  relative w-full h-72 bg-[#1b1b42] flex  justify-center overflow-hidden">
              <div className="img-form absolute bg-[#1b1b42] inset-1 p-1 z-10">
                <img src={img} alt="" className="w-full h-full" />
              </div>
            </div>
            <div className="txt-container   relative w-full h-[200px] bg-[#34347f] mt-2  pl-4 text-[#00ccff]">
              <div className="flex flex-col h-3/4">
                <p className="text-xl font-bold ">{bolg_title}</p>
                {/* <p className="pt-3  ">
